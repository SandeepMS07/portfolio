...
export interface Globe3DConfig {
  ...
  /** Emissive (glow) color for lit areas — e.g. warm city lights on a night map */
  ...
  return (
    <group ref={groupRef} visible={isVisible}>
      ...
      <mesh position={surfacePosition} quaternion={lineQuaternion}>
        ...
        <meshBasicMaterial color={hovered ? "#ff9347" : "#ff5e2c"} />
      </mesh>
...
function RotatingGlobe({
  ...
  // Load Earth textures (configured on load to avoid mutating hook results)
